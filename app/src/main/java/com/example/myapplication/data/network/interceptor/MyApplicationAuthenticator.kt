package com.example.myapplication.data.network.interceptor
...
class MyApplicationAuthenticator(
    ...
    override fun authenticate(route: Route?, response: Response): Request? {
        ...
        val newAccessToken = runBlocking {
            try {
                val authTokens = authRepository.getAuthTokensFlow().first() ?: return@runBlocking ""
