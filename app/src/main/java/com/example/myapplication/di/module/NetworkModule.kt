...
import com.example.myapplication.data.network.interceptor.AuthorizationInterceptor
import com.example.myapplication.data.network.interceptor.MyApplicationAuthenticator
...
//                addNetworkInterceptor(UserAgentInterceptor(userAgent))
                ...
                authenticator(MyApplicationAuthenticator(authRepository))
